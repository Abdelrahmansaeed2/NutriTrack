...
class _GroceryListScreenState extends State<GroceryListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Expanded(
              child: BlocBuilder<GroceryCubit, GroceryState>(
                builder: (context, state) {
                  ...
                  if (state is GroceryNoListButPlanExists) {
                    return Center(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'You have an active weekly meal plan! Let\'s generate an automated grocery list from it.',
                            ...
                            ElevatedButton.icon(
                              onPressed: () => context
                                  .read<GroceryCubit>()
                                  .generateGroceryList(state.planId),
      ...
      floatingActionButton: BlocBuilder<GroceryCubit, GroceryState>(
        builder: (context, state) {
          if (state is GroceryLoaded) {
